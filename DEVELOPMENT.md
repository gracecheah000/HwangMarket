...
The contract ABI has changed quite a bit since the time this was written, so the examples below might not be accurate but it still demonstrates the basic idea of what the contract seeks to achieve.
